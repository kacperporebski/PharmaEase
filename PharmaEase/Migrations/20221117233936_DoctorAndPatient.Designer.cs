...
namespace PharmaEase.Migrations
{
    ...
    [Migration("20221117233936_DoctorAndPatient")]
    partial class DoctorAndPatient
    {
            ...
            modelBuilder.Entity("PharmaEase.Models.Patient", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("GovtHealthNum"), 1L, 1);
            ...
            modelBuilder.Entity("PharmaEase.Models.Prescription", b =>
                {
                    ...
                    b.Property<int>("PatientHealthNum")
                        .HasColumnType("int");
