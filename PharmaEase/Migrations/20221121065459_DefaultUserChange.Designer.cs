...
namespace PharmaEase.Migrations
{
    ...
    [Migration("20221121065459_DefaultUserChange")]
    partial class DefaultUserChange
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PharmaEase.Areas.Identity.Data.Patient", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PharmaEase.Areas.Identity.Data.Patient", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PharmaEase.Models.Prescription", b =>
                {
                    ...
                    b.HasOne("PharmaEase.Areas.Identity.Data.Patient", "Patient")
                        .WithMany()
