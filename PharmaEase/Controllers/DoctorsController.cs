...
namespace PharmaEase.Controllers
{
    ...
    public class DoctorsController : Controller
    {
        ...
        public DoctorsController(PharmaEaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MedicalLicenseId,Phone,Fname,Lname,ApprovAdminId")] Doctor doctor)
        {
